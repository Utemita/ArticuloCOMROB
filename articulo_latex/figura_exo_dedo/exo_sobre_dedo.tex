...
\newif\ifconfondo
\confondofalse            % <-- cambiar a \confondotrue cuando este la foto
...
\newcommand{\dedoancho}{22cm}     % ancho de la foto en coords del dibujo
\newcommand{\dedox}{10.4}         % centro X de la foto
\newcommand{\dedoy}{6.6}          % centro Y de la foto
