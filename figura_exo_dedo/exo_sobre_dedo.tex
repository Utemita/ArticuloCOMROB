...
\newcommand{\mecEsc}{0.58}        % escala (falanges mas pequenas)
\newcommand{\mecAng}{17}          % inclinacion en grados (sigue el dedo)
\newcommand{\mecMx}{9.4}          % destino X del pivote M (sobre la MCP)
\newcommand{\mecMy}{5.0}          % destino Y del pivote M (dorso)
