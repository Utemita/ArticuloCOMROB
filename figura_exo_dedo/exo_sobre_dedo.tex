...
\newcommand{\mecMy}{5.8}          % destino Y del pivote M (un poco mas arriba, sobre el dorso)
...
\begin{tikzpicture}[
  ...
  \coordinate (K)  at (6.0, 3.8);    % vertice theta_aux_fm (Fp-Fm-c2)  [Fp mas larga]
  \coordinate (M)  at (13.7, 3.8);   % pivote tierra inf (theta_1m4B)
  \coordinate (Fmp) at (3.2, 2.6);   % extremo libre de Fm
