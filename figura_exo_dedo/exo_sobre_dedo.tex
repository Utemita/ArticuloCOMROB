...
\begin{tikzpicture}[
    x=0.62cm,y=0.62cm,
    esl/.style={line width=3.3pt,line cap=round,black},   % eslabon (mas grueso)
  ...
  % -------------------------------------------------------------------
  \coordinate (A)  at (3.4, 6.6);    % junta far-left  (L8, c2)  [c2 mas corta]
  \coordinate (B)  at (8.0,10.6);    % sup-izq         (L6, L7, L8)
  \coordinate (C)  at (14.4,10.8);   % sup-der         (L6, L2, L3)  [L6 algo mas corta]
  \coordinate (D)  at (18.6, 6.1);   % extremo der     (L1, L2)      [L1 algo mas corta]
  ...
  \coordinate (K)  at (5.5, 3.8);    % vertice theta_aux_fm (Fp-Fm-c2)  [Fp un pelin mas larga]
  \coordinate (M)  at (13.7, 3.8);   % pivote tierra inf (theta_1m4B)
  \coordinate (Fmp) at (2.1, 2.35);  % extremo libre de Fm  [Fm un poco mas larga]
  ...
  \foreach \n in {A,B,C,D,E,F,G,H,I,K,M,Fmp,Hf,If}{
    \filldraw[fill=white,draw=black,line width=1.1pt] (\n) circle (0.20);
  }
