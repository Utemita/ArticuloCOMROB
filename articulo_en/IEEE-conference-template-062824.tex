...
To the original model [] a third four-bar stage is added, in order to correct
...
$\theta_1=\theta_2/r_g+\theta_{\text{off}}$. The direct kinematics sequentially
solves the four-bar loops and propagates the positions of the PIP and the DIP
